...
<!--                            <img :src="item.url" style="width: 68px; height: 68px">            -->
                    ...
                    <div class="book-share">
                        ...
                        <div class="icon-collection">
                            <i class="el-icon-star-on" @click="collection"></i><span>{{collectionPer}}</span>
                        </div>
                    </div>
                </div>
            </div>
...
<!--                                        <img src="./../assets/img/imgdetail.jpg" alt="">-->
                                ...
                                <div class="detail-box-second-item"  ref="bianji" id="#anchor-1">
                                    ...
                                    <!--内容-->
                                    <div class="detail-box-second-note">
                                        <div v-for="(item,index) in editList" :key="index" class="detail-box-second-note-item">
                                ...
                                <div class="detail-box-second-item"  ref="meiti" id="#anchor-6">
                                    ...
                                    <!--内容-->
                                    <div class="detail-box-second-note">
                                        <div v-for="(item,index) in mediaList" :key="index" class="detail-box-second-note-item">
                                ...
                                <span><el-button type="text" @click="dialogCommentVisible = true">写评论</el-button>
                                    <el-dialog
                                        ...
                                        <div style="display:flex;flex-direction: row;align-items: center;margin-bottom: 5px;">
                                            ...
                                            <div v-text="writescoreValue=writescore*2"
                                        ...
                                        <span slot="footer" class="dialog-footer">
                                            ...
                                            <el-button type="primary" @click="dialogCommentVisible = false;writeCommit()">发 表</el-button>
                                        </span>
                                    </el-dialog>
                                </span>
                            </div>
...
<!--                                                <img src="./../assets/img/photo1.png" alt="">-->
        ...
        <div class="displayRight" :style="rightFixed">
            ...
            <div class="right-tab-item">
                <div class="right-tab-item-tab" v-for="(item,index) in rightTab" :key="index" :class="{active : activeBtn == index}" @click="goAnchor('#anchor-'+index,index)">
    ...
    export default {
        ...
        data() {
            return {
                ...
                //内容简介
                brieflyList:{brieflyDes:'《人类简史》探讨了人类从哪里来，颠覆了我们关于人类进化的认知，理清了影响人类发展的重大脉络。人类究竟是怎么回事？我们是无以伦比的智慧动物吗？时代要进入后人类时代了吗？尤瓦尔·赫拉利在《人类简史》中，融合了生物学、历史学、社会学、心理学、哲学、经济学、政治学等多个学科前沿知识，打破了学科和思维局限，对人类历史提出了新的诠释。\n' +
                            '\n' +
                ...
                mediaList:[
                    ...
                    {mediaDes:'尤瓦尔·赫拉利的书十分有趣并令人兴奋……他告诉我们人类是怎样在地球上生存的，农业以及科学存在的时间是如此之短，以至于我们不应该将之视为理所当然。',prefaceName:'奥巴马，第44任美国总统'},
                    {mediaDes:'《未来简史》是一部震撼人心，同时又趣味盎然的作品。重点是，这本书会颠覆你的思考方式。',prefaceName:'丹尼尔·卡尼曼，诺贝尔经济学奖得主、《思考，快与慢》作者'},
                    {mediaDes:'人类正面临全新的问题，解决全新的问题需要全新的公司和全新的思路。这本《今日简史》就是我们这一代人可以去解决的那些大问题的21条清单，是21个千亿乃至万亿美金的机会。',prefaceName:'罗振宇，罗辑思维、得到App创始人'},
                    {mediaDes:'有多少历史学家对当前生物学的进展信手拈来？有多少宗教哲学家了解现代科学对人的“意识”的理解？有多少经济学家能同时用历史、心理和动物学的理论解释，让大规模人群合作，和小团队互动，有什么本质的区别？非得有一位像赫拉利这样通才式的学者，才能把这一切综合起来，让我们对现代世界有深入的见识。',prefaceName:'万维钢，科学作家，得到《精英日课》专栏作者'}
                ],
                //侧边固定
        ...
        methods: {
            ...
            handleScroll() {
                ...
                if(this.activeBook=='first'){
                    if (scrollTop > 780) {
                        this.rightFixed = this.rightFixedb
                    } else if (scrollTop < 784 || scrollTop > (meiti+scrollTop+meitil) ) {
                        this.rightFixed = this.rightFixedn
                    }
                }
                if((tese + scrollTop) < scrollTop && scrollTop < (bianji+scrollTop)){
                    ...
                    this.activeBtn = 5;
                }else if((meiti + scrollTop) < scrollTop && scrollTop < (meiti+scrollTop+meitil)){
                    this.activeBtn = 6;
                }
            },
            //侧边固定
